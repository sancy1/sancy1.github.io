...
async function handleSubmit(event) {
    ...
    fetch(event.target.action, {
        ...
        if (response.ok) {
            status.innerHTML = "Thank you for reaching out! Your form submission has been successfully received. We appreciate your interest, and our team will get back to you as soon as possible. If you have any urgent inquiries, feel free to contact us directly. Thanks again for choosing us!";
            form.reset()
        } else {
